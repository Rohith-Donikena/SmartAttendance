...
firebase_admin.initialize_app(cred,{
    ...
    'storageBucket':'smartattendance-7b3c8.appspot.com'
})
...
while True:
    ...
    if counter!=0:
        ...
        if modeType!=3:
            ...
            if counter<=10:
                cv2.putText(imgBackground,str(studentInfo['total_attendance']),(858,112),cv2.FONT_HERSHEY_SCRIPT_COMPLEX,1,(255,255,255),1)
                ...
                cv2.putText(imgBackground, str(studentInfo['branch']), (1005, 539), cv2.FONT_HERSHEY_TRIPLEX, 0.6, (255,255,255),1)
